...
type Success = Awaited<ReturnType<ReturnType<typeof todoRepositories>['create']>>
...
export function useTodoCreate(
  ...
  return useMutation<Success, Error, Exclude<Params, undefined>>({
    ...
    mutationFn: params => todoRepositories(http).create(params),
...
export function useTodoCreateOptimistic(
  ...
  >({
    ...
    mutationFn: newTodo => todoRepositories(http).create(newTodo),
