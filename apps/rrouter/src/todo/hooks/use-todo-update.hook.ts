...
type Success = Awaited<ReturnType<ReturnType<typeof todoRepositories>['update']>>
...
export function useTodoUpdate(
  ...
  return useMutation<Success, Error, Exclude<Params, undefined>>({
    ...
    mutationFn: params => todoRepositories(http).update(params),
...
export function useTodoUpdateOptimistic(
  ...
  >({
    ...
    mutationFn: updateTodo => todoRepositories(http).update(updateTodo),
