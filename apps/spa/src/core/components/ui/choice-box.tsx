...
const renderChoiceBoxItemContent = (
  ...
  if (renderedChildren !== undefined) {
    if (typeof renderedChildren === "string") {
      return <ChoiceBoxLabel>{renderedChildren}</ChoiceBoxLabel>;
    }
  ...
  return (
    <GridListItem
      ...
      className={composeRenderProps(
        className,
        (itemClassName, { isFocusVisible, isSelected, ...renderProps }) =>
          choiceBoxItemStyles({
            ...renderProps,
    ...
    >
      {composeRenderProps(children, (renderedChildren, { selectionMode }) => (
        <>
          {renderChoiceBoxItemContent(renderedChildren, label, description)}
