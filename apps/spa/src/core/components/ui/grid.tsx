...
function Grid({ className, gap, gapX, gapY, flow, columns, rows, ...props }: GridProps) {
  return (
    <div
      ...
      className={gridStyles({
        ...
        className:
          'debug' in props
            ? twMerge('*:data-[slot=grid-cell]:border-warning *:data-[slot=grid-cell]:border', className)
            : className,
      })}
      {...props}
    >
