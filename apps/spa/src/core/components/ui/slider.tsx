...
import { composeRenderProps, SliderOutput, Slider as SliderPrimitive, SliderStateContext, SliderThumb as SliderThumbPrimitive, SliderTrack as SliderTrackPrimitive } from 'react-aria-components'
