...
export const SwitchField = ({ className, ...props }: SwitchFieldProps) => (
...
const renderSwitchChildren = (
  ...
  values: Parameters<NonNullable<SwitchButtonProps["children"]>>[0]
) => {
  ...
  >
    {(values) => (
      <>
        ...
        {renderSwitchChildren(children, values)}
      </>
    )}
  </SwitchButton>
);
