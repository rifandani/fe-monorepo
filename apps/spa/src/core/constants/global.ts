...
export const SERVICE_NAME = 'feMonorepoSpa'
...
export const TRACER_REACT_ENTRY_ON_CAUGHT_ERROR = 'reactEntry.onCaughtError'
export const TRACER_REACT_ENTRY_ON_UNCAUGHT_ERROR = 'reactEntry.onUncaughtError'
export const TRACER_REACT_ENTRY_ON_RECOVERABLE_ERROR = 'reactEntry.onRecoverableError'
