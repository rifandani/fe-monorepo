...
const renderOgLogo = (logo: string | null, isLight: boolean) => {
  if (logo === "next") {
    return isLight ? <LightNextSvg /> : <DarkNextSvg />;
  }
  if (logo === "react") {
    return isLight ? <LightReactSvg /> : <DarkReactSvg />;
  }
  return null;
};
