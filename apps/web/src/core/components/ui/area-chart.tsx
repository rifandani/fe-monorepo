...
const DEFAULT_AREA_CHART_DATA: never[] = [];
const DEFAULT_AREA_CHART_FORMATTER = (value: number) => value.toString();

export const AreaChart = ({
  data = DEFAULT_AREA_CHART_DATA,
  dataKey,
  ...
  valueFormatter = DEFAULT_AREA_CHART_FORMATTER,
  // XAxis
