...
const DEFAULT_BAR_LIST_DATA: never[] = [];
const DEFAULT_BAR_LIST_FORMATTER = (value: number) => value.toString();

export const BarList = <T,>({
  data = DEFAULT_BAR_LIST_DATA,
  valueFormatter = DEFAULT_BAR_LIST_FORMATTER,
  onValueChange,
