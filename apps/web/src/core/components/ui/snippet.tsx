...
import type { TabPanelProps, TabsProps } from "react-aria-components/Tabs";
import { TabsContext } from "react-aria-components/Tabs";
...
export const SnippetTabsList = <T extends object>({
  className,
  ...props
}: TabListProps<T>) => {
