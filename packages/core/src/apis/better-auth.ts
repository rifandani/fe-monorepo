...
export const authRepositories = (http: InstanceType<typeof Http>) =>
  ({
    /**
     * GET ${env.apiBaseUrl}/api/auth/get-session
    ...
    /**
     * POST ${env.apiBaseUrl}/api/auth/sign-in/email
     * @throws {HTTPError} When the HTTP request fails
     * @throws {TimeoutError} When the request times out
     * @throws {ZodError} When response validation fails
     */
    ...
    /**
     * POST ${env.apiBaseUrl}/api/auth/sign-out
     * @throws {HTTPError} When the HTTP request fails
     * @throws {TimeoutError} When the request times out
     * @throws {ZodError} When response validation fails
     */
    ...
    /**
     * POST ${env.apiBaseUrl}/api/auth/sign-up/email
     * @throws {HTTPError} When the HTTP request fails
     * @throws {TimeoutError} When the request times out
     * @throws {ZodError} When response validation fails
     */
